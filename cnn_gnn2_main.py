...
dataset = Dataset.Dataset_system(np.load('sh_data.npy')[:62, :, :, :])
validdataset = Dataset.Dataset_system(np.load('sh_data.npy')[48:69 ,:,:, :])
testdataset = Dataset.Dataset_system(np.load('sh_data.npy')[55:,:,:, :])
